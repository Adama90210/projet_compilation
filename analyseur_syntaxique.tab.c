...
{
  "$end", "error", "$undefined", "SI", "POINT_VIRGULE", "PLUS", "MOINS",
  "FOIS", "DIVISE", "PARENTHESE_OUVRANTE", "PARENTHESE_FERMANTE",
  "CROCHET_OUVRANT", "CROCHET_FERMANT", "ACCOLADE_OUVRANTE",
  "ACCOLADE_FERMANTE", "EGAL", "INFERIEUR", "ET", "OU", "NON", "ALORS",
  "SINON", "TANTQUE", "FAIRE", "ENTIER", "RETOUR", "LIRE", "ECRIRE",
  "IDENTIF", "NOMBRE", "VIRGULE", "$accept", "programme", YY_NULLPTR
};
#endif
...
#line 1234 "analyseur_syntaxique.tab.c" /* yacc.c:1646  */
      default: break;
    }
...
#line 54 "analyseur_syntaxique.y" /* yacc.c:1906  */
